      ...
      if (response['status'] == 'success') {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Turnamen berhasil dihapus"),
                ...
                onSelected: (value) async {
                  if (value == 'edit') {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => EditTournamentFormPage(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildInfoRow(
                            ...
                            label: "Teams",
                            value: "$_currentTeamCount Team Terdaftar",
                          ),
                          const Divider(height: 24),
                          _buildInfoRow(
                            ...
                            label: "Prize",
                            value:
                                (widget.tournament.prizePool != null &&
                                    widget.tournament.prizePool!.isNotEmpty)
                                ? "Rp ${widget.tournament.prizePool}"
                                : "Tidak ada hadiah",
                          ),
                        ],
                      ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              MatchListPage(tournament: widget.tournament),
                        ),
                      );
                    },
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      final result = await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              JoinTournamentPage(tournament: widget.tournament),
                        ),
                      );
